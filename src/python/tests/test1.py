...
news_talk_train = fetch(subset='all' , categories =talk_cat , remove=('headers' , 'footers' , 'quotes'))
news_tech_train = fetch(subset='all' , categories = tech_cat , remove=('headers' , 'footers' , 'quotes'))
...
selector = features_selection.Dict_Merge_Feature_Selector(features_selection.combined)
